...
export default function Contact() {
  return (
    ...
    >
      <div className="flex-1 flex flex-col xl:flex-row justify-center md:items-center z-10 gap-12 md:gap-32 w-full max-w-[1800px] mx-auto font-[family-name:var(--font-space-grotesk)]">
        <div className="flex flex-col w-full xl:w-1/2 shrink-0">
          ...
          <a
            ...
            className="text-[18vw] xl:text-[10vw] font-black leading-[0.85] uppercase tracking-tighter hover:text-white/70 transition-colors block text-white"
          >
            SAY
            <br />
            HELLO.
      ...
      <div className="w-full flex flex-col md:flex-row justify-between items-center text-[10px] md:text-xs tracking-widest font-mono text-gray-500 uppercase py-8 border-t border-white/10 z-10 gap-6 md:gap-0 max-w-[1800px] mx-auto text-center md:text-left">
